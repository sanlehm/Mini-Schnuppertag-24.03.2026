...
PLAYER_IMG_PATHS = ['assets/images/robin.png', 'assets/images/player.png']  # Aufgabe 4: Array
player_skin_index = 0  # Aufgabe 4
...
# Aufgabe 5: Turbo-Variablen
ULT_ACTIVE = False
ULT_START = 0

# Zeit-Stopp-Variablen
...
def handle_input(engine, event):
    global ULT_ACTIVE, ULT_START, TIME_STOP_ACTIVE, TIME_STOP_START, player_skin_index
    player = engine.player

    # Aufgabe 5: Turbo nach 2 Sekunden deaktivieren
    if ULT_ACTIVE and pygame.time.get_ticks() - ULT_START > 2000:
        ULT_ACTIVE = False

    # Zeit-Stopp nach 3 Sekunden deaktivieren
    if TIME_STOP_ACTIVE and pygame.time.get_ticks() - TIME_STOP_START > TIME_STOP_DURATION:
        TIME_STOP_ACTIVE = False
        engine.TIME_STOP_ACTIVE = False
    ...
    if event.type == pygame.KEYDOWN:
        ...
        # Aufgabe 5: Geschwindigkeit verdoppeln wenn Turbo aktiv
        speed = 2 if ULT_ACTIVE else 1

        # Aufgabe 3: WASD-Steuerung
        ...
        if event.key == pygame.K_t and not TIME_STOP_ACTIVE:
            ...
            engine.TIME_STOP_ACTIVE = True
            engine.TIME_STOP_START = TIME_STOP_START

        # Aufgabe 5: Turbo mit U
